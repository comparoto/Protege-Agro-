# Contribuindo para o Protege Agro 👨‍🌾

Olá! Bem-vind@ ao nosso projeto 👋


As orientações a seguir ajudarão você a entender como nosso projeto funciona e como você pode participar de forma eficaz.
...
3.  Inclua:
    ...
    * Compare o comportamento esperado com o comportamento observado.
    * Adicione um print se possível.
